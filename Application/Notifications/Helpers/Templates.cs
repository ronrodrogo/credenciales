...
public static class Templates
{
    public static async Task<string> FillTemplate(string templatePath, string fileName, Dictionary<string, string> @params)
    {
        try
        {
            ...
            //if (templatePath.Contains("EmailTemplates"))
            //{
            //    var fileMsgPath = Path.Combine(AppDomain.CurrentDomain.BaseDirectory, templatePath, "HTML");
            //    template = await File.ReadAllTextAsync(fileMsgPath);
            //}
